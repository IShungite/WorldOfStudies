...
import { CreateShopService } from '#domain/services/shop/create_shop.service'
import { createShopValidator } from '#infrastructure/validators/shop/create_shop.validator'
