import { CreatePromotionService } from '#domain/services/promotion/create_promotion.service'
import { createPromotionValidator } from '#infrastructure/validators/school/create_promotion.validator'
